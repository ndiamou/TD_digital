...
# Chemin du fichiert
dossier = r"G:\_NPI\00-Digital\Alternant Mountakha Ndiaye\Stats documents\Machine Roussine\Roussine - Vibration EC5"
...
SEUILS_PENTE = {
    "Vitesse": {"pmin": -0.25, "pmax": 0.25, "r2max": 800.0},
...
def lire_premier_excel(dossier):
    ...
    # Nettoyage
    # Détermine les colonnes "requises" minimales, on peut ajouter le nombre disponible
    req = ["Date"]
